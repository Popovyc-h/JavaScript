...
Об'єктно-орієнтоване програмування на базі сучасних класів стандарту ES6+ дозволяє структурувати бізнес-логіку застосунку, гарантувати інкапсуляцію стану через приватні поля (`#field`), розмежовувати публічний та внутрішній інтерфейси, а також централіМзовано вести облік через статичні властивості й методи.
